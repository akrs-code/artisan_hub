...
const InventoryStatCard = ({ title, value, subtext, subtextColor = 'text-neutral-dark/60', icon: Icon, iconBgClass = 'bg-[#F5EDE8]' }) => {
  return (
    <div className="card-custom !p-6 flex flex-col justify-between h-40 group hover:card-custom-hover">
      <div className="flex justify-between items-start">
        <h3 className="text-[11px] font-sans font-bold tracking-widest text-neutral-dark/60 uppercase max-w-[60%] leading-relaxed">
          {title}
        </h3>
        {Icon && (

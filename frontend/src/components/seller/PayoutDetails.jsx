  ...
  return (
    <div className="card-custom !p-8 flex flex-col h-full group hover:card-custom-hover mt-6 lg:mt-0">
      ...
      <div className="mb-8">
        ...
        <div className="bg-[#F8F5F0] rounded-lg p-5 border-l-4 border-[#8C5233]">
          <div className="text-[15px] font-headline font-bold text-neutral-dark mb-1">
            {nextPayoutDate}
          </div>
          <div className="text-[10px] font-sans font-bold text-[#8C5233]">
            {scheduleType}
          </div>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="border border-neutral-dark/10 rounded-lg p-5 flex items-center gap-4">
          <div className="w-10 h-10 rounded-md bg-[#F8F5F0] flex items-center justify-center shrink-0">
            <Building2 className="w-5 h-5 text-[#8C5233]" />
          </div>
          <div>
